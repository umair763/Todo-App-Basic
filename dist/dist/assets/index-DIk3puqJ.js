...
function mc(e) {
    return e === null || typeof e != 'object'
        ? null
        : ((e = (Oi && e[Oi]) || e['@@iterator']), typeof e == 'function' ? e : null);
}
var Yu = {
        isMounted: function () {
            return !1;
...
var se = { current: null },
    xr = { transition: null },
    gc = { ReactCurrentDispatcher: se, ReactCurrentBatchConfig: xr, ReactCurrentOwner: Ho };
function es() {
 ...
 */ (function (e) {
            ...
            e: for (var W = 0, G = E.length, nr = G >>> 1; W < nr; ) {
                ...
                if (0 > l(kl, T))
                    wt < G && 0 > l(rr, kl)
                        ? ((E[W] = rr), (E[wt] = T), (W = wt))
                        : ((E[W] = kl), (E[gt] = T), (W = gt));
                else if (wt < G && 0 > l(rr, T)) (E[W] = rr), (E[wt] = T), (W = wt);
                else break e;
            }
        }
        return z;
    ...
    function c(E) {
        for (var z = n(f); z !== null; ) {
            ...
            else if (z.startTime <= E) r(f), (z.sortIndex = z.expirationTime), t(s, z);
            else break;
            z = n(f);
        }
    }
    function v(E) {
        if (((S = !1), c(E), !y))
            if (n(s) !== null) (y = !0), fn(x);
            else {
                var z = n(f);
                z !== null && dn(v, z.startTime - E);
            }
    }
    function x(E, z) {
        (y = !1), S && ((S = !1), d(P), (P = -1)), (w = !0);
        var T = m;
        try {
            for (c(z), p = n(s); p !== null && (!(p.expirationTime > z) || (E && !he())); ) {
                var W = p.callback;
                if (typeof W == 'function') {
                    (p.callback = null), (m = p.priorityLevel);
                    var G = W(p.expirationTime <= z);
                    (z = e.unstable_now()), typeof G == 'function' ? (p.callback = G) : p === n(s) && r(s), c(z);
                } else r(s);
                p = n(s);
            }
            if (p !== null) var nr = !0;
                ...
                var gt = n(f);
                gt !== null && dn(v, gt.startTime - z), (nr = !1);
            }
            return nr;
        } finally {
            (p = null), (m = T), (w = !1);
        ...
        (e.unstable_scheduleCallback = function (E, z, T) {
            ...
            return (
                ...
                T > W
                    ? ((E.sortIndex = T),
                      t(f, E),
                      n(s) === null && E === n(f) && (S ? (d(P), (P = -1)) : (S = !0), dn(v, T - W)))
                    : ((E.sortIndex = G), t(s, E), y || w || ((y = !0), fn(x))),
                E
            );
        }),
...
var Qe = !(typeof window > 'u' || typeof window.document > 'u' || typeof window.document.createElement > 'u'),
    ...
    Ai = {};
function Tc(e) {
    return Xl.call(Ai, e) ? !0 : Xl.call(Ui, e) ? !1 : zc.test(e) ? (Ai[e] = !0) : ((Ui[e] = !0), !1);
}
function Lc(e, t, n, r) {
...
function Ac(e, t, n, r, l, o, i, u, s) {
    (Nn = !1), (Mr = null), Ic.apply(Uc, arguments);
}
...
function ti(e, t, n, r) {
    if (Ur) {
        var l = po(e, t, n, r);
        if (l === null) Fl(e, t, r, Ar, n), Xi(e, r);
        else if (ef(l, e, t, n, r)) r.stopPropagation();
        else if ((Xi(e, r), t & 4 && -1 < bc.indexOf(e))) {
            for (; l !== null; ) {
                var o = er(l);
                if ((o !== null && Ls(o), (o = po(e, t, n, r)), o === null && Fl(e, t, r, Ar, n), o === l)) break;
                l = o;
            }
    ...
    ol = B({}, bn, {
        ...
        movementX: function (e) {
            return 'movementX' in e
                ...
                : (e !== yn &&
                      (yn && e.type === 'mousemove'
                          ? ((Pl = e.screenX - yn.screenX), (zl = e.screenY - yn.screenY))
                          : (zl = Pl = 0),
                      (yn = e)),
                  Pl);
        },
...
var gf = B({}, bn, {
    ...
    xf = Se(Sf),
    Ef = B({}, sn, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
    Cf = Se(Ef),
    _f = B({}, ol, {
        deltaX: function (e) {
...
var zf = Qe && 'TextEvent' in window && !Pn,
...
function lu() {
    zn && (zn.detachEvent('onpropertychange', Bs), ($n = zn = null));
}
function Bs(e) {
    if (e.propertyName === 'value' && il($n)) {
        var t = [];
        $s(t, $n, e, Jo(e)), Ss(Df, t);
    }
}
function Mf(e, t, n) {
    e === 'focusin' ? (lu(), (zn = t), ($n = n), zn.attachEvent('onpropertychange', Bs)) : e === 'focusout' && lu();
}
function Of(e) {
            ...
            if (m !== void 0) {
                ...
                for (var a = f, c; a !== null; ) {
                    ...
                    if (
                        (c.tag === 5 &&
                            v !== null &&
                            ((c = v), d !== null && ((v = Fn(a, d)), v != null && S.push(Hn(a, v, c)))),
                        R)
                    )
                        break;
                    a = a.return;
                }
                0 < S.length && ((m = new w(m, y, null, n, h)), p.push({ event: m, listeners: S }));
            }
        }
        if (!(t & 7)) {
            e: {
                if (
                    ...
                    m && n !== io && (y = n.relatedTarget || n.fromElement) && (xt(y) || y[Ke]))
                )
                    break e;
                if (
                    (w || m) &&
                    ...
                    if (
                        ...
                        (e === 'pointerout' || e === 'pointerover') &&
                            ((S = bi), (v = 'onPointerLeave'), (d = 'onPointerEnter'), (a = 'pointer')),
                        (R = w == null ? m : $t(w)),
                        (c = y == null ? m : $t(y)),
                        (m = new S(v, a + 'leave', w, n, h)),
                        (m.target = R),
                        (m.relatedTarget = c),
                        (v = null),
                        xt(h) === f &&
                            ((S = new S(d, a + 'enter', y, n, h)), (S.target = c), (S.relatedTarget = R), (v = S)),
                        (R = v),
                        w && y)
                    )
                        t: {
                            for (S = w, d = y, a = 0, c = S; c; c = Mt(c)) a++;
                            for (c = 0, v = d; v; v = Mt(v)) c++;
                            for (; 0 < a - c; ) (S = Mt(S)), a--;
                            for (; 0 < c - a; ) (d = Mt(d)), c--;
                            for (; a--; ) {
                    ...
                    w !== null && cu(p, m, w, S, !1), y !== null && R !== null && cu(p, R, y, S, !0);
                }
            }
            e: {
                if (
            ...
            switch (((_ = f ? $t(f) : window), e)) {
                case 'focusin':
                    (nu(_) || _.contentEditable === 'true') && ((Ut = _), (mo = f), (Tn = null));
                    break;
                case 'focusout':
                    Tn = mo = Ut = null;
                    break;
            ...
            P &&
                (Is &&
                    ...
                    (It || P !== 'onCompositionStart'
                        ...
                        : ((tt = h), (ni = 'value' in tt ? tt.value : tt.textContent), (It = !0))),
                (_ = $r(f, P)),
                0 < _.length &&
                    ((P = new qi(P, e, null, n, h)),
                    p.push({ event: P, listeners: _ }),
                    N ? (P.data = N) : ((N = As(n)), N !== null && (P.data = N)))),
                (N = zf ? Tf(e, n) : Lf(e, n)) &&
                    ((f = $r(f, 'onBeforeInput')),
                    0 < f.length &&
...
function hu(e, t, n) {
    ...
    n ? ((e = bs(e, t, Pt)), (r.__reactInternalMemoizedMergedChildContext = e), I(de), I(oe), O(oe, e)) : I(de),
        O(de, n);
}
var Ve = null,
    al = !1,
...
function ta(e, t, n) {
    (xe[Ee++] = Be), (xe[Ee++] = He), (xe[Ee++] = zt), (zt = e);
    var r = Be;
    e = He;
    var l = 32 - De(r) - 1;
    (r &= ~(1 << l)), (n += 1);
...
function si(e) {
    ...
    for (; e === zt; )
        (zt = xe[--Ee]), (xe[Ee] = null), (He = xe[--Ee]), (xe[Ee] = null), (Be = xe[--Ee]), (xe[Ee] = null);
}
var ge = null,
    ye = null,
    A = !1,
    ...
    if (A) {
        ...
        if (t) {
            ...
            if (!vu(e, t)) {
                ...
                t = it(n.nextSibling);
                var r = ge;
                t && vu(e, t) ? na(r, n) : ((e.flags = (e.flags & -4097) | 2), (A = !1), (ge = e));
            }
        } else {
            if (xo(e)) throw Error(g(418));
...
function la(e) {
    ...
    function s(d, a, c, v) {
        ...
        return x === Ft
            ...
            : a !== null &&
              (a.elementType === x || (typeof x == 'object' && x !== null && x.$$typeof === Je && gu(x) === a.type))
            ? ((v = l(a, c.props)), (v.ref = gn(d, a, c)), (v.return = d), v)
            : ((v = Dr(c.type, c.key, c.props, null, d.mode, v)), (v.ref = gn(d, a, c)), (v.return = d), v);
    }
    function f(d, a, c, v) {
        return a === null ||
            a.tag !== 4 ||
            ...
            ? ((a = Kl(c, d.mode, v)), (a.return = d), a)
            : ((a = l(a, c.children || [])), (a.return = d), a);
    }
    function h(d, a, c, v, x) {
        return a === null || a.tag !== 7
            ? ((a = Nt(c, d.mode, v, x)), (a.return = d), a)
            : ((a = l(a, c)), (a.return = d), a);
    }
    function p(d, a, c) {
        ...
        if (typeof a == 'object' && a !== null) {
            switch (a.$$typeof) {
                ...
                case Je:
                    var v = a._init;
                    return p(d, v(a._payload), c);
            }
            if (xn(a) || pn(a)) return (a = Nt(a, d.mode, c, null)), (a.return = d), a;
            vr(d, a);
        }
        return null;
    }
    function m(d, a, c, v) {
        ...
        if ((typeof c == 'string' && c !== '') || typeof c == 'number') return x !== null ? null : u(d, a, '' + c, v);
        if (typeof c == 'object' && c !== null) {
            switch (c.$$typeof) {
                case or:
                    return c.key === x ? s(d, a, c, v) : null;
                case Ot:
                    return c.key === x ? f(d, a, c, v) : null;
                case Je:
                    return (x = c._init), m(d, a, x(c._payload), v);
            }
            if (xn(c) || pn(c)) return x !== null ? null : h(d, a, c, v, null);
            vr(d, c);
        }
        return null;
    }
    function w(d, a, c, v, x) {
        if ((typeof v == 'string' && v !== '') || typeof v == 'number')
            return (d = d.get(c) || null), u(a, d, '' + v, x);
        if (typeof v == 'object' && v !== null) {
            switch (v.$$typeof) {
                case or:
                    return (d = d.get(v.key === null ? c : v.key) || null), s(a, d, v, x);
                case Ot:
                    return (d = d.get(v.key === null ? c : v.key) || null), f(a, d, v, x);
                case Je:
                    var _ = v._init;
                    return w(d, a, c, _(v._payload), x);
            }
            if (xn(v) || pn(v)) return (d = d.get(c) || null), h(a, d, v, x, null);
            vr(a, v);
        }
        return null;
    }
    function y(d, a, c, v) {
        for (var x = null, _ = null, N = a, P = (a = 0), U = null; N !== null && P < c.length; P++) {
        ...
        if (P === c.length) return n(d, N), A && kt(d, P), x;
        if (N === null) {
            for (; P < c.length; P++)
                (N = p(d, c[P], v)), N !== null && ((a = o(N, a, P)), _ === null ? (x = N) : (_.sibling = N), (_ = N));
            return A && kt(d, P), x;
        }
    ...
    function S(d, a, c, v) {
        ...
        if (((c = x.call(c)), c == null)) throw Error(g(151));
        for (var _ = (x = null), N = a, P = (a = 0), U = null, L = c.next(); N !== null && !L.done; P++, L = c.next()) {
            N.index > P ? ((U = N), (N = null)) : (U = N.sibling);
            var he = m(d, N, L.value, v);
            if (he === null) {
                N === null && (N = U);
                break;
            }
            e && N && he.alternate === null && t(d, N),
                (a = o(he, a, P)),
                _ === null ? (x = he) : (_.sibling = he),
                (_ = he),
                (N = U);
        }
        if (L.done) return n(d, N), A && kt(d, P), x;
        if (N === null) {
            for (; !L.done; P++, L = c.next())
                (L = p(d, L.value, v)),
                    L !== null && ((a = o(L, a, P)), _ === null ? (x = L) : (_.sibling = L), (_ = L));
            return A && kt(d, P), x;
        }
            ...
            switch (c.$$typeof) {
                case or:
                    e: {
                        for (var x = c.key, _ = a; _ !== null; ) {
                            if (_.key === x) {
                                if (((x = c.type), x === Ft)) {
                                    ...
                                    _.elementType === x ||
                                    (typeof x == 'object' && x !== null && x.$$typeof === Je && gu(x) === _.type)
                                ) {
                                    n(d, _.sibling),
                                        (a = l(_, c.props)),
                                        (a.ref = gn(d, _, c)),
                        ...
                        c.type === Ft
                            ? ((a = Nt(c.props.children, d.mode, v, c.key)), (a.return = d), (d = a))
                            : ((v = Dr(c.type, c.key, c.props, null, d.mode, v)),
                              (v.ref = gn(d, a, c)),
                              (v.return = d),
                              (d = v));
                    }
                ...
                case Ot:
                    ...
                    return i(d);
                case Je:
                    return (_ = c._init), R(d, a, _(c._payload), v);
            }
            if (xn(c)) return y(d, a, c, v);
            if (pn(c)) return S(d, a, c, v);
            vr(d, c);
        }
        return (typeof c == 'string' && c !== '') || typeof c == 'number'
            ? ((c = '' + c),
              a !== null && a.tag === 6
                  ...
                  : (n(d, a), (a = Ql(c, d.mode, v)), (a.return = d), (d = a)),
              i(d))
            : n(d, a);
    }
    return R;
            ...
            if ((r & m) === m) {
                ...
                e: {
                    ...
                    switch (((m = t), (w = n), S.tag)) {
                        ...
                        case 0:
                            if (((y = S.payload), (m = typeof y == 'function' ? y.call(w, p, m) : y), m == null))
                                break e;
                            p = B({}, p, m);
                            break e;
                        case 2:
...
function wi(e, t, n, r, l, o) {
    ...
    if (((Pr.current = Jr), (t = Y !== null && Y.next !== null), (Tt = 0), (Z = Y = V = null), (Zr = !1), t))
        throw Error(g(300));
    return e;
}
function ki() {
    ...
    if (l !== null) {
        ...
        do {
            ...
            if ((Tt & h) === h)
                ...
                s === null ? ((u = s = p), (i = r)) : (s = s.next = p), (V.lanes |= h), (Lt |= h);
            }
            f = f.next;
        } while (f !== null && f !== o);
        s === null ? (i = r) : (s.next = u),
...
function Ea(e, t, n) {
    return Tt & 21
        ? (Me(n, t) || ((n = zs()), (V.lanes |= n), (Lt |= n), (e.baseState = !0)), t)
...
var Jr = {
    ...
    rd = {
        ...
        useImperativeHandle: function (e, t, n) {
            return (n = n != null ? n.concat([e]) : null), zr(4194308, 4, wa.bind(null, t, e), n);
        },
...
function Da(e, t, n) {
    ...
    if (r.mode === 'hidden')
        if (!(t.mode & 1))
            (t.memoizedState = { baseLanes: 0, cachePool: null, transitions: null }), O(Kt, ve), (ve |= n);
        else {
            if (!(n & 1073741824))
                return (
    ...
    else o !== null ? ((r = o.baseLanes | n), (t.memoizedState = null)) : (r = n), O(Kt, ve), (ve |= r);
...
function Lu(e, t, n, r, l) {
    ...
    if ((Jt(t, l), t.stateNode === null)) Tr(e, t), za(t, n, r), No(t, n, r, l), (r = !0);
    else if (e === null) {
        var i = t.stateNode,
            u = t.memoizedProps;
        i.props = u;
...
function sd(e, t, n, r, l, o, i) {
    ...
    if (((u = (i & e.childLanes) !== 0), fe || u)) {
        ...
        return Ti(), (r = Hl(Error(g(421)))), yr(e, t, i, r);
    }
    return l.data === '$?'
        ...
        : ((e = o.treeContext),
          ...
          (A = !0),
          (je = null),
          e !== null && ((xe[Ee++] = Be), (xe[Ee++] = He), (xe[Ee++] = zt), (Be = e.id), (He = e.overflow), (zt = t)),
          (t = Ei(t, r.children)),
          (t.flags |= 4096),
          t);
}
        ...
        case 13:
            if (((r = t.memoizedState), r !== null))
                return r.dehydrated !== null
                    ...
                    ? Oa(e, t, n)
                    : (O($, $.current & 1), (e = Xe(e, t, n)), e !== null ? e.sibling : null);
            O($, $.current & 1);
            break;
        case 19:
            ...
            if (!r.hasOwnProperty(f) && l.hasOwnProperty(f) && l[f] != null)
                if (f === 'style') {
                    ...
                    f !== 'dangerouslySetInnerHTML' &&
                        ...
                        f !== 'autoFocus' &&
                        (Mn.hasOwnProperty(f) ? o || (o = []) : (o = o || []).push(f, null));
        for (f in r) {
            var s = r[f];
    ...
    switch ((si(t), t.tag)) {
                            ...
                            i === 'children'
                                ? typeof u == 'string'
                                    ...
                                    : typeof u == 'number' &&
                                      ...
                                      (o.suppressHydrationWarning !== !0 && mr(r.textContent, u, e),
                                      (l = ['children', '' + u]))
                                : Mn.hasOwnProperty(i) && u != null && i === 'onScroll' && F('scroll', r);
                        }
                    switch (n) {
                        case 'input':
                            ir(r), Bi(r, o, !0);
        ...
        case 13:
            if (
                ...
                if (A && ye !== null && t.mode & 1 && !(t.flags & 128)) ra(), tn(), (t.flags |= 98560), (o = !1);
            ...
            return t.flags & 128
                ...
                : ((r = r !== null),
                  ...
                  null);
        case 4:
            return rn(), Do(e, t), e === null && Bn(t.stateNode.containerInfo), ne(t), null;
        case 10:
        ...
        case 23:
            return (
                ...
                r && t.mode & 1 ? ve & 1073741824 && (ne(t), t.subtreeFlags & 6 && (t.flags |= 8192)) : ne(t),
                null
            );
        case 24:
            return null;
                            ...
                            case 1:
                                if (y !== null) {
                                    var S = y.memoizedProps,
                                        R = y.memoizedState,
                                        d = t.stateNode,
                                        a = d.getSnapshotBeforeUpdate(t.elementType === t.type ? S : Te(t.type, S), R);
...
function Ha(e, t) {
    ...
    switch (e.tag) {
        ...
        case 1:
            ...
            break;
        case 5:
            if ((ze(t, e), Oe(e), r & 512 && n !== null && Qt(n, n.return), e.flags & 32)) {
                var l = e.stateNode;
                try {
                    On(l, '');
                } catch (S) {
...
function Qa(e, t) {
    ...
    if (r & 30 || r & e.expiredLanes || t) t = tl(e, r);
        ...
        D |= 2;
        var o = Ya();
        (J !== e || b !== t) && (($e = null), (on = Q() + 500), _t(e, t));
        do
            try {
                gd();
                break;
        ...
        while (!0);
        fi(), (qr.current = o), (D = l), K !== null ? (t = 0) : ((J = null), (b = 0), (t = X));
    }
    if (t !== 0) {
        if ((t === 2 && ((l = co(e)), l !== 0 && ((r = l), (t = Ao(e, l)))), t === 1))
        ...
        if (t === 6) et(e, r);
            ...
            if (
                ...
                !(r & 30) &&
                    !vd(l) &&
                    ((t = tl(e, r)), t === 2 && ((o = co(e)), o !== 0 && ((r = o), (t = Ao(e, o)))), t === 1))
            )
                throw ((n = Zn), _t(e, 0), et(e, r), me(e, Q()), n);
            switch (((e.finishedWork = l), (e.finishedLanes = r), t)) {
                ...
                case 3:
                    if ((et(e, r), (r & 130023424) === r && ((t = Ni + 500 - Q()), 10 < t))) {
                        ...
                        e.timeoutHandle = wo(St.bind(null, e, ce, $e), t);
                        break;
                    }
                    St(e, ce, $e);
                    break;
                case 4:
                    ...
                    if (
                        ...
                        e.timeoutHandle = wo(St.bind(null, e, ce, $e), r);
                        break;
                    }
                    St(e, ce, $e);
                    break;
...
function Au(e) {
    ...
    return (e.finishedWork = e.current.alternate), (e.finishedLanes = t), St(e, ce, $e), me(e, Q()), null;
}
function Pi(e, t) {
    var n = D;
    D |= 1;
...
function jt(e) {
    ...
    try {
        ...
        (M = r), (_e.transition = n), (D = t), !(D & 6) && ht();
    }
}
function zi() {
    (ve = Kt.current), I(Kt);
...
function Ti() {
    (X === 0 || X === 3 || X === 2) && (X = 4), J === null || (!(Lt & 268435455) && !(pl & 268435455)) || et(J, b);
}
function tl(e, t) {
    var n = D;
    D |= 2;
...
function St(e, t, n) {
    var r = M,
        l = _e.transition;
    try {
        (_e.transition = null), (M = 1), wd(e, t, n, r);
    } finally {
        (_e.transition = l), (M = r);
    }
    return null;
...
function qt() {
    if (nt !== null) {
        var e = Ts(el),
            ...
            n = M;
        try {
            if (((_e.transition = null), (M = 16 > e ? 16 : e), nt === null)) var r = !1;
            else {
...
function $u(e, t, n) {
    (t = ln(n, t)), (t = Ta(e, t, 1)), (e = ut(e, t, 1)), (t = ue()), e !== null && (qn(e, 1, t), me(e, t));
}
function H(e, t, n) {
    if (e.tag === 3) $u(e, e, n);
    else
...
function kd(e, t, n) {
    ...
    r !== null && r.delete(t),
        ...
        J === e &&
            (b & n) === n &&
            (X === 4 || (X === 3 && (b & 130023424) === b && 500 > Q() - Ni) ? _t(e, 0) : (_i |= n)),
        me(e, t);
}
function Za(e, t) {
...
Ja = function (e, t, n) {
    ...
    else (fe = !1), A && t.flags & 1048576 && ta(t, Qr, t.index);
            ...
            return (
                ...
                typeof l == 'object' && l !== null && typeof l.render == 'function' && l.$$typeof === void 0
                    ? ((t.tag = 1),
                      ...
                      No(t, r, e, n),
                      (t = To(null, t, r, !0, o, n)))
                    : ((t.tag = 0), A && o && ui(t), ie(null, t, l, n), (t = t.child)),
                t
            );
        case 16:
            r = t.elementType;
            ...
            return t;
        case 0:
            return (r = t.type), (l = t.pendingProps), (l = t.elementType === r ? l : Te(r, l)), zo(e, t, r, l, n);
        case 1:
...
ws = Pi;
ks = jt;
var Td = { usingClientEntryPoint: !1, Events: [er, $t, sl, ys, gs, Pi] },
    kn = { findFiberByHostInstance: xt, bundleType: 0, version: '18.3.1', rendererPackageName: 'react-dom' },
    Ld = {
    ...
    return k.jsx('div', {
        ...
        children: k.jsxs('div', {
            ...
            children: [
                ...
                k.jsx('p', { className: `time ${e.status ? 'strikethough' : ''}`, children: e.task }),
                k.jsxs('div', {
                    className: 'time',
                    children: [
                        k.jsx('p', { className: `${e.status ? 'strikethough' : ''} timendateGap`, children: e.date }),
                        k.jsx('p', { className: `${e.status ? 'strikethough' : ''}`, children: e.time }),
                        k.jsx('input', { type: 'checkbox', className: 'checkbox', checked: e.status, onChange: n }),
                    ],
                }),
            ],
        }),
...
function Dd({ todolist: e, searched: t, newtask: n, marked: r, toggleTaskStatus: l }) {
    return k.jsx(k.Fragment, {
        children: k.jsx('div', {
            ...
            children:
                t !== null
                    ? t.map((o, i) => k.jsx(Wu, { list: o, id: i, newtask: n, toggleTaskStatus: l }, i))
                    : e.map((o, i) => k.jsx(Wu, { list: o, id: i, newtask: n, toggleTaskStatus: l }, i)),
        }),
    });
}
    ...
    return k.jsxs(k.Fragment, {
        children: [
            k.jsxs('div', {
                ...
                children: [
                    k.jsx('p', { className: 'rgbcolors', children: '🔴🟡🟢' }),
                    k.jsx('input', {
                        type: 'text',
                        className: 'searchbar',
                        placeholder: 'Search...',
                    ...
                    k.jsxs('select', {
                        ...
                        children: [
                            k.jsx('option', { children: 'Sort by' }),
                            k.jsx('option', { children: 'Task' }),
                            k.jsx('option', { children: 'Important' }),
                        ],
                    }),
                ],
            }),
            k.jsxs('div', {
                className: 'buttons',
                children: [
                    k.jsx('button', { className: 'addbtn', onClick: e, children: 'Add Task' }),
                    k.jsx('button', { className: 'deletebtn', onClick: t, children: 'Delete Task' }),
                    k.jsx('button', {
...
function Md({ SetisAddFormVisible: e, addTask: t }) {
    ...
    function m(w) {
        w.preventDefault();
        const y = { color: n, task: l, date: i, time: s, status: !1 };
        console.log(y), n !== '' && l !== '' && i !== '' && s !== '' && (t(y), r(''), o(''));
    }
    return k.jsx(k.Fragment, {
        children: k.jsxs('form', {
            ...
            onSubmit: m,
            children: [
                k.jsx('label', { children: 'Choose color' }),
                k.jsxs('select', {
                    className: 'addentrysortby',
                    value: n,
                    onChange: (w) => r(w.target.value),
                    children: [
                        k.jsx('option', { children: 'set color' }),
                        k.jsx('option', { children: 'red' }),
                        k.jsx('option', { children: 'yellow' }),
                        k.jsx('option', { children: 'green' }),
                    ],
                }),
                k.jsx('label', { children: 'Write task' }),
                k.jsx('input', { type: 'text', className: 'writeTask', value: l, onChange: (w) => o(w.target.value) }),
                k.jsx('label', { children: 'Set Date' }),
                k.jsx('input', { type: 'date', className: 'settime', onChange: (w) => u(p(w.target.value)) }),
                k.jsx('label', { children: 'Set time' }),
                k.jsx('input', { type: 'time', className: 'settime', onChange: (w) => f(h(w.target.value)) }),
                k.jsx('button', { className: 'confirmbtn', children: 'Confirm' }),
                k.jsx('button', { className: 'closebtn', onClick: e, children: 'Close' }),
            ],
        }),
    });
}
function Od({ setisDeleteFormVisible: e, deleteTask: t }) {
    const [n, r] = le.useState(''),
        [l, o] = le.useState(''),
        [i, u] = le.useState(''),
        [s, f] = le.useState('');
    ...
    return k.jsx(k.Fragment, {
        children: k.jsxs('form', {
            ...
            onSubmit: h,
            children: [
                k.jsx('label', { children: 'Enter color' }),
                k.jsxs('select', {
                    className: 'addentrysortby2',
                    value: l,
                    onChange: (p) => o(p.target.value),
                    children: [
                        k.jsx('option', { children: 'Enter color' }),
                        k.jsx('option', { children: 'red' }),
                        k.jsx('option', { children: 'yellow' }),
                        k.jsx('option', { children: 'green' }),
                    ],
                }),
                k.jsx('label', { children: 'Enter task' }),
                k.jsx('input', { type: 'text', className: 'writeTask2', value: n, onChange: (p) => r(p.target.value) }),
                k.jsx('label', { children: 'Enter Date' }),
                k.jsx('input', { type: 'date', className: 'settime2', value: i, onChange: (p) => u(p.target.value) }),
                k.jsx('label', { children: 'Enter time' }),
                k.jsx('input', { type: 'time', className: 'settime2', value: s, onChange: (p) => f(p.target.value) }),
                k.jsx('button', { className: 'confirmbtn2', children: 'Confirm' }),
                k.jsx('button', { className: 'closebtnn', onClick: e, children: 'Close' }),
            ],
        }),
    });
}
const Fd = [
    { color: 'yellow', task: 'Demo Task', date: '2024-07-21', date: '21-07-2024', time: '10:00 AM', status: !1 },
    { color: 'yellow', task: 'UI/UX Design Meeting (Demo)', date: '22-08-2024', time: '11:00 AM', status: !1 },
    { color: 'green', task: 'Project Component Development (Demo)', date: '12-09-2024', time: '05:00 AM', status: !1 },
    { color: 'red', task: 'Project Component  (Demo)', date: '04-09-2024', time: '09:00 AM', status: !1 },
    { color: 'green', task: 'Development (Demo)', date: '04-09-2024', time: '01:00 PM', status: !1 },
    { color: 'green', task: 'Development (Demo)', date: '11-07-2024', time: '11:00 AM', status: !1 },
];
function Id() {
    const [e, t] = le.useState(!1),
        [n, r] = le.useState(!1),
        [l, o] = le.useState(Fd),
        [i, u] = le.useState('sortby'),
        [s, f] = le.useState('');
    function h() {
        t((a) => !a), n && r(!1);
    }
    ...
    i === 'Task' && (y = y.slice().sort((a, c) => a.task.localeCompare(c.task))),
        i === 'Important' &&
            ((y = y.slice().sort((a, c) => {
                const v = new Date(a.date.split('-').reverse().join('-')),
                    x = new Date(c.date.split('-').reverse().join('-')),
                    _ = v - x;
                if (_ !== 0) return _;
                const [N, P] = a.time.split(' '),
                    ...
                    E = fn * 60 + parseInt(wl, 10);
                return dn - E;
            })),
            y.length > 0 && (y[0].color = 'red'));
    let S = y;
    s && (S = y.filter((a) => a.task.toLowerCase().includes(s.toLowerCase())));
    function R(a) {
        o((c) => c.map((v) => (v.task === a ? { ...v, status: !v.status } : v)));
    }
    function d() {
                    ...
                    k.jsxs('div', {
                        ...
                        children: [
                            k.jsxs('div', {
                                className: 'text',
                                children: [
                                    k.jsx('h1', { children: 'Todo App' }),
                                    k.jsx('h3', { children: 'To-Do lists help us break life into small steps.' }),
                                ],
                            }),
                            k.jsx(Rd, {
                                SetisAddFormVisible: h,
                                setisDeleteFormVisible: p,
                                setSort: u,
                                setSearch: f,
                                DeleteAllMarked: d,
                            }),
                            k.jsx(Dd, { todolist: y, searched: S, toggleTaskStatus: R, newtask: l }),
                        ],
                    }),
                    k.jsx('div', {
                        ...
                        children: k.jsxs('div', {
                            ...
                            children: [
                                e ? k.jsx(Md, { addTask: m, SetisAddFormVisible: h }) : '',
                                n ? k.jsx(Od, { deleteTask: w, setisDeleteFormVisible: p }) : '',
                            ],
                        }),
                    }),
                ],
...
Yl.createRoot(document.getElementById('root')).render(k.jsx(wc.StrictMode, { children: k.jsx(Id, {}) }));
